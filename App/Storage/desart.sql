...
CREATE TABLE IF NOT EXISTS `Desart`.`da_article` (
  ...
  CONSTRAINT `fk_article_article_category`
    FOREIGN KEY (`article_category_id`)
    REFERENCES `Desart`.`da_article_category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 0;
...
CREATE TABLE IF NOT EXISTS `Desart`.`da_user` (
  ...
  `hash` VARCHAR(150) CHARACTER SET 'ascii' COLLATE 'ascii_general_ci' NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `Desart`.`da_message` (
  ...
  CONSTRAINT `fk_message_message_group1`
    ...
    REFERENCES `Desart`.`da_message_group` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `Desart`.`da_article_history` (
  ...
  CONSTRAINT `fk_article_history_article1`
    ...
    REFERENCES `Desart`.`da_article` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Desart`.`da_micro_comment` (
  ...
  CONSTRAINT `fk_micro_comments_comment_history1`
    ...
    REFERENCES `Desart`.`da_comment_history` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Desart`.`da_comment_vote` (
  ...
  CONSTRAINT `fk_comments_votes_comments1`
    ...
    REFERENCES `Desart`.`da_comment` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Desart`.`da_micro_commnet_vote` (
  ...
  CONSTRAINT `fk_micro_commnet_vote_micro_comment1`
    ...
    REFERENCES `Desart`.`da_micro_comment` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Desart`.`da_message_user_group` (
  ...
  CONSTRAINT `fk_message_user_group_message_group1`
    ...
    REFERENCES `Desart`.`da_message_group` (`id` , `user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Desart`.`da_newsletter` (
  ...
  CONSTRAINT `fk_newsletter_selection1`
    ...
    REFERENCES `Desart`.`da_selection` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
